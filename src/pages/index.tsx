  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="v4 is a streamlined, efficient solution for scheduling and managing medical appointments. Experience hassle-free healthcare scheduling like never before."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1651008376811-b90baee60c1f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkb2N0b3J8ZW58MHx8fHwxNjkzMzM0NjU1fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`v4 is a streamlined, efficient solution for scheduling and managing medical appointments. Experience hassle-free healthcare scheduling like never before.`}
            </Text>
            <Box
