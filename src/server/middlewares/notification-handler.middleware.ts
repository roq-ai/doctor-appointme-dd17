...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'doctor.create': {
    roles: ['system-administrator', 'healthcare-provider', 'medical-staff', 'insurance-provider'],
    key: 'doctor-added',
    tenantPath: ['organization', 'doctor'],
    userPath: [],
  },
  'service.delete': {
    roles: ['system-administrator', 'healthcare-provider', 'medical-staff', 'insurance-provider'],
    key: 'service-removed',
    tenantPath: ['organization', 'service'],
    userPath: [],
  },
  'appointment.create': {
    roles: ['system-administrator', 'healthcare-provider', 'medical-staff', 'insurance-provider'],
    key: 'appointment-booked',
    tenantPath: ['organization', 'doctor', 'appointment'],
    userPath: [],
  },
};
